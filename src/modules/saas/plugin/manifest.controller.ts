  ...
  school: [
    ...
    { title: 'Auto Marketing Studio', icon: 'campaign', route: '/school/auto-marketing', apiEndpoint: '/v1/dynamic/marketing', roles: ['admin'] },
    {
      ...
      children: [
        ...
        { title: 'Upload Notes', icon: 'cloud_upload', route: '/school/upload-notes', apiEndpoint: '/v1/dynamic/study_materials', roles: ['*'] },
        { title: 'Upload Sheet', icon: 'upload_file', route: '/school/upload-sheet', apiEndpoint: '/v1/dynamic/date_sheets', roles: ['*'] },
        { title: 'Create Sheet', icon: 'note_add', route: '/school/create-sheet', apiEndpoint: '/v1/dynamic/created_datesheets', roles: ['*'] },
        { title: 'Holiday List', icon: 'event', route: '/school/holidays', apiEndpoint: '/v1/dynamic/holidays', roles: ['*'] },
        { title: 'Calendar', icon: 'event_note', route: '/school/calendar', apiEndpoint: '/v1/dynamic/activities', roles: ['*'] },
  ...
  institute: [
    ...
    { title: 'Auto Marketing Studio', icon: 'campaign', route: '/institute/auto-marketing', apiEndpoint: '/v1/dynamic/marketing', roles: ['admin'] },
    {
      ...
      children: [
        ...
        { title: 'Upload Notes', icon: 'cloud_upload', route: '/institute/upload-notes', apiEndpoint: '/v1/dynamic/study_materials', roles: ['*'] },
        { title: 'Upload Sheet', icon: 'upload_file', route: '/institute/upload-sheet', apiEndpoint: '/v1/dynamic/date_sheets', roles: ['*'] },
        { title: 'Create Sheet', icon: 'note_add', route: '/institute/create-sheet', apiEndpoint: '/v1/dynamic/created_datesheets', roles: ['*'] },
        { title: 'Holiday List', icon: 'event', route: '/institute/holidays', apiEndpoint: '/v1/dynamic/holidays', roles: ['*'] },
        { title: 'Calendar', icon: 'event_note', route: '/institute/calendar', apiEndpoint: '/v1/dynamic/activities', roles: ['*'] },
...
const PORTAL_WIDGETS: Record<string, PortalWidget[]> = {
  ...
  institute: [
    ...
    },
    {
      ...
      title: 'Today Fees',
      icon: 'account_balance_wallet',
      apiEndpoint: '/institute/fees/today',
      countTable: 'fee_payments',
      roles: ['admin'],
    },
    {
